...
const NotificationItem = ({ notification, onView }: PropsType) => {
  return (
    <div onClick={() => onView(notification)} title={notification.type}>
      <div className="px-4 py-2 bg-purple-50 dark:bg-[#222] dark:hover:bg-[#333] rounded-xl cursor-pointer hover:bg-purple-100">
        ...
        <p className="line-clamp-4 dark:text-white">
          {notification.type == "post_approved"
